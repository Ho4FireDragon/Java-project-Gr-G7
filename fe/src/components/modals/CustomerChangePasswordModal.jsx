...
CustomerChangePasswordModal.propTypes = {
...
function CustomerChangePasswordModal({ isOpen, onOpenChange }) {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            try {
                const response = await customerApi.changePassword(authUser.id, values.newPassword)
